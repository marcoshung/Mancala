...
public class GameManager {
    ...
    /**
     * Major process of running the game, each round of game starts from a paticular
     * pit.
     * 
    ...
    /**
     * To check if the current game process meets the Mancala Case, that is player's
     * last drop falls into his/her own mancala
     * 
    ...
    /**
     * To check if the current game process meets the special case, that is player's
     * last drop falls into his/her own empty pit
     * 
     * @param cur_pit        current pit index that the game is processing
     * @param take_out_stone stones in player's hand
     * @return stones left in player's hand
